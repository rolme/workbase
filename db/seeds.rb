...
Feature.create([
  ...
  { name: 'Task Management', description: 'Vis ignota interpretaris in. Mei ne munere libris atomorum. Sed ipsum timeam et. Delenit inimicus id mea, an eos iisque latine maiorum, ne nibh qualisque duo. Te his meis facilis iracundia, usu justo efficiantur ne. Labores consulatu pri an, libris impedit duo ut. Ex utinam soluta interesset cum.', monthly_price: 25.0, settings: '' },
])
...
puts ">> adding tasks ..."
Task.create(company: company, title: 'Follow up with John Swigert RE: video feed', position: 2, due_at: 1.week.from_now)
Task.create(company: company, title: 'Create position listing on career site', priority: 2, position: 1, due_at: 1.week.from_now)
Task.create(company: company, title: 'Inquire about additional storage spaces', priority: 1, position: 0, due_at: 1.day.ago, completed_at: 1.day.ago)
