...
Feature.create([
  ...
  { name: 'Procurement Management', description: 'Nobis utamur debitis at est, vel in fugit alienum, no malorum sensibus nam. Eros sensibus eu qui, feugiat commune accommodare sed ea. Has cu ignota invenire constituam, nam ea prima labitur reprehendunt. Ex decore corpora vis, labitur debitis vituperata mei cu, his an tale discere. Legendos incorrupte intellegebat duo ex, alii wisi mea ad. Ne tollit partem officiis vis, te nam maluisset mediocritatem. Quo ne iudico scripserit, vix ne sanctus vulputate, blandit salutatus deseruisse te nam.', monthly_price: 25.0, settings: '' },
])
